...
SECRET_KEY = 'u7i)$yc0be54g)me_dkq0inexlo)i3gl94ndskwb(^fh6c7%y7'
...
# since theres no need for an SMTP server at the momment i can send the requests in the console
